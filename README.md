...
| :--- | :--- |
| **Name** | Mehram Nisha |
| **Registration No** | 2025-APC-70 |
| **Degree Program** | BS Applied Computing |
...
This SRS document demonstrates the practical application of:
1. **SDLC (Software Development Life Cycle):** From requirements gathering to maintenance.
2. **Requirements Engineering:** Functional, Non-Functional, and Stakeholder analysis.
3. **Risk Management:** Identifying and mitigating system risks.
4. **Ethical AI Integration:** Using AI for predictions while maintaining human oversight.

---

##  How to View the Document
To read the full SRS, please download or open the **QueueSmart_SRS.pdf** file located in this repository.

---
*Built with  by Mehram Nisha | University of Engineering and Technology, Lahore*
